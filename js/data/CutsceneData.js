...
const CUTSCENE_DATA = {
    ...
    opening: {
        ...
        typewriter: false,
        sequence: [
            { text: '도심지. 밤.', duration: 1500, color: '#888888', size: '16px', y: 300 },
            { text: '주인공이 걸어간다.\n어떤 건물 안으로 들어간다.', duration: 2000, color: '#888888', size: '16px', y: 300 },
            { text: '"야, 케이크 아직?"', duration: 1500, color: '#ffffff', size: '20px', y: 280 },
            { text: '"12시 딱 되면 자를 거야."', duration: 1500, color: '#ffffff', size: '20px', y: 280 },
            { text: '23:57', duration: 1000, color: '#666666', size: '48px', y: 300 },
            { text: '23:58', duration: 1000, color: '#666666', size: '48px', y: 300 },
            { text: '23:59', duration: 1500, color: '#999999', size: '48px', y: 300 },
            { text: '00:00:00', duration: 800, color: '#ffffff', size: '56px', y: 300 },
            { text: null, duration: 1000 }, // 무음
            { text: '낯선 공간.\n콘크리트. 낡은 건물 내부.', duration: 2000, color: '#555555', size: '18px', y: 300 },
        ],
    ...
    rooftop: {
        ...
        typewriter: true,
        sequence: [
            { text: '옥상. 하늘이 없다.\n검은 공간이 위로 무한히 펼쳐져 있다.', duration: 2000, color: '#555555', size: '16px', y: 250 },
            { text: null, duration: 1500 },
            { text: '"어서와…"', duration: 2000, color: '#ff4444', size: '28px', y: 300 },
            { text: null, duration: 1000 },
            { text: '"생일이라며."', duration: 1500, color: '#ff4444', size: '24px', y: 300 },
            { text: null, duration: 1000 },
            { text: '"선물을 줘야 하는데."', duration: 1500, color: '#ff4444', size: '24px', y: 280 },
            { text: '"시간을 주지."', duration: 1500, color: '#ff4444', size: '24px', y: 300 },
            { text: '"3분."', duration: 2000, color: '#ff0000', size: '36px', y: 300 },
        ],
    ...
    true_red_1_clear: {
        bgColor: '#0a0005',
        sequence: [
            { text: '무수히 죽는 모습.', duration: 2000, color: '#888888', size: '16px', y: 250 },
    ...
    true_red_3_clear: {
        bgColor: '#0a0005',
        sequence: [
            { text: '갇혀 있는 곳을 찾지 못하는 마왕.', duration: 2000, color: '#888888', size: '16px', y: 250 },
    ...
    true_red_4_clear: {
        bgColor: '#0a0005',
        sequence: [
            { text: '사건에 접근하려는 마왕.', duration: 2000, color: '#888888', size: '16px', y: 250 },
    ...
    ending_c: {
        ...
        sequence: [
            ...
            { text: null, duration: 2000 },
            { text: '마왕이 투명해지기 시작한다.', duration: 2000, color: '#666666', size: '16px', y: 300 },
            { text: null, duration: 2000 },
    ...
    post_ending: {
        ...
        typewriter: false,
        sequence: [
            { text: '도심지. 밤.', duration: 1500, color: '#cccccc', size: '16px', y: 300 },
            { text: '"야, 케이크 아직?"', duration: 1500, color: '#ffffff', size: '20px', y: 280 },
            { text: '"12시 딱 되면 자를 거야."', duration: 1500, color: '#ffffff', size: '20px', y: 280 },
            { text: '00:00:00', duration: 1500, color: '#ffffff', size: '48px', y: 300 },
            { text: '"생일 축하해!"', duration: 2000, color: '#ffd700', size: '28px', y: 300 },
